...
public class RunGameController : MonoBehaviour
{
    ...
    [SerializeField] private int randomPose;
    [SerializeField] private GameObject posePlayer;
    [SerializeField] private GameObject poseTrainer;
    ...
    private void LoadTrainerSprite(int pose)
    {
        poseTrainer.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>($"treinador_0{pose}");
    }
